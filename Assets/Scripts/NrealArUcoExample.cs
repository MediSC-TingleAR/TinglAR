...
namespace NrealLightWithOpenCVForUnityExample
{
    ...
    public class NrealArUcoExample : MonoBehaviour
    {
        ...
        /// </summary>
        public float markerLength = 0.03f; //10cm

        /// <summary>
        /// The AR game object.
        /// </summary>
        public ARGameObjectSubgame arGameObject;

        [HeaderAttribute("--------Test--------")]
        public GameObject FreezeCount;
        public GameObject FindSticker;
        ...
        public void OnWebCamTextureToMatHelperInitialized()
        {
            ...
            distCoeffs = new MatOfDouble(new double[] { distort.distortParams[1], distort.distortParams[2], distort.distortParams[3], distort.distortParams[4], distort.distortParams[5] });
